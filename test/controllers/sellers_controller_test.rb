...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { country_id: @seller.country_id, name: @seller.name, seller_uid: @seller.seller_uid, status: @seller.status, tax_id: @seller.tax_id }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { country_id: @seller.country_id, name: @seller.name, seller_uid: @seller.seller_uid, status: @seller.status, tax_id: @seller.tax_id }
    assert_redirected_to seller_path(assigns(:seller))
  end
